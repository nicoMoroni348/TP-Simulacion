...
from support import get_table, validar_parametros, validar_distribuciones, \
    probabilidad_a_distribucion, validar_i_j, validar_n
...
class SimulationApp:
    ...
    def comenzar_simulacion(self):
        ...
        v_e, u_f = simulacion_visitas(self.n_visitas, self.i, self.j, self.utilidad_por_suscripcion, 
                            self.probabilidad_genero, self.probabilidad_venta_a_sra, 
                            self.distribucion_suscripciones_sra, self.distribucion_suscripciones_sr)
    ...
    def abrir_menu_actualizar_parametros(self):
        ...
        self.probabilidad_puerta_abierta_entry.config(state='disabled')
        ...
        self.probabilidad_venta_a_sr_entry.config(state='disabled')
