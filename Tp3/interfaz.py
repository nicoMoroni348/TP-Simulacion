...
def pedir_n():
    n_visitas_value = simpledialog.askstring("Nuevo numero de simulacion", "Ingrese n:")

    # Aca Hacer la validacion de n


    print(n_visitas_value)

def actualizar_parametros_top_level():
...
def abrir_opciones():
    ...
    generar_simulacion_button = tk.Button(opciones, text="Generar simulación", bg='#add8e6', activebackground='#87ceeb', bd=0, relief='groove', overrelief='groove', highlightbackground='black')
    ...
    actualizar_parametros_button = tk.Button(opciones, text="Actualizar parámetros", command=actualizar_parametros_top_level, bg='#add8e6', activebackground='#87ceeb', bd=0, relief='groove', overrelief='groove', highlightbackground='black')
